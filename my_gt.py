...
if __name__ == '__main__':
    ...
    #create_youtube_gt(video_dir, gt_src_dir, gt_dest_file, sum_rate = 0.15)

    # create ground-truth for OpenVideo
    video_dir = str(config.video_dir_openvideo)
    gt_src_dir = str(config.gt_dir_openvideo)
    gt_dest_file = str(config.gt_dir_openvideo) + '/gt_openvideo.h5'
    create_openvideo_gt(video_dir, gt_src_dir, gt_dest_file, sum_rate = 0.15)